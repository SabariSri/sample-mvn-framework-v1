...
public class CustomExtentReports {
	...
	public void startReport() {
		extent = new ExtentReports(System.getProperty("user.dir") + "/CustomTestOutput/Report.html", true);
		extent.addSystemInfo("Host Name", "Crazy Frog").addSystemInfo("Environment", "QA").addSystemInfo("User Name",
				"Sabari");
		extent.loadConfig(new File(System.getProperty("user.dir") + "/CustomTestOutput/extent-config.xml"));
	}
